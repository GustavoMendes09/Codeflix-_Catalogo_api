...
namespace FC.Codeflix.Catalog.UnitTests.Application.Genre.UpdateGenre
{
    ...
    public class UpdateGenreTest
    {
        ...
        public async Task UpdateGenreAddingCategoriesIds()
        {
            ...
            var input = new UpdateGenreInput(exampleGenre.Id, newNameExample, newIsActive, exampleCategoriesIdsList);
            ...
            exampleCategoriesIdsList.ForEach(id => output.Categories.Should().Contain(id));
        ...
        public async Task ThrowWhenCategoryNotFound()
        {
            ...
            var input = new UpdateGenreInput(exampleGenre.Id, newNameExample, newIsActive, exampleNewCategoriesIdsList);

            var action = async () => await useCase.Handle(input, CancellationToken.None);

            var notFounfIdsAsString = string.Join(", ", idsNotReturnedByCategoryRepository);
             await action.Should().ThrowAsync<RelatedAggregateException>()
                .WithMessage($"Related category id (or ids) not found: {notFounfIdsAsString}");
        }
