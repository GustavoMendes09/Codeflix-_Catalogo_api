...
namespace FC.Codeflix.Catalog.UnitTests.Domain.Entity.Category
{
    ...
    public class CategoryTest
    {
        ...
        public void InstantiateErrorWhenDescriptionIsNull()
        {
            ...
            //Assert.Equal("Description should not bem empty or null", exception.Message);
        }

        [Theory(DisplayName = nameof(InstantiateErrorWhenNameIsLessThan3Characterers))]
        [Trait("Domain", "Category - Aggregates")]
        [InlineData("1")]
        [InlineData("12")]
        [InlineData("a")]
        public void InstantiateErrorWhenNameIsLessThan3Characterers(string invalidName)
        {
            var validCategory = _categoryTestFixture.GetValidCategory();
        ...
        [Fact(DisplayName = nameof(InstantiateErrorWhenNameIsGreaterThan255Characterers))]
        [Trait("Domain", "Category - Aggregates")]
        public void InstantiateErrorWhenNameIsGreaterThan255Characterers()
        {
            var validCategory = _categoryTestFixture.GetValidCategory();
        ...
        [Fact(DisplayName = nameof(InstantiateErrorWhenNameIsGreaterThan10_000Characterers))]
        [Trait("Domain", "Category - Aggregates")]
        public void InstantiateErrorWhenNameIsGreaterThan10_000Characterers()
        {
            var validCategory = _categoryTestFixture.GetValidCategory();
        ...
        [Theory(DisplayName = nameof(InstantiateErrorWhenNameIsEmpty))]
        [Trait("Domain", "Category - Aggregates")]
        [MemberData(nameof(GetNameWithLessThan3Characters), parameters: 5)]
